                ...
                <div className="flex gap-3 sm:gap-6 items-center">
                    <SignedOut>
                        <button 
                            ...
                            className="hidden sm:flex items-center gap-2 text-sm font-black uppercase tracking-widest hover:text-gray-500 transition-colors"
                        >
                        ...
                        <button onClick={() => navigate("/register")} className="bg-black text-white px-4 sm:px-6 py-2.5 rounded-lg text-xs sm:text-sm font-black uppercase tracking-widest hover:bg-gray-800 transition-all shadow-lg shadow-black/10">Join Now</button>
                    </SignedOut>
                    <SignedIn>
                        <button onClick={() => navigate("/feed")} className="bg-black text-white px-6 py-2.5 rounded-lg text-sm font-black uppercase tracking-widest hover:bg-gray-800 transition-all shadow-lg shadow-black/10">Go to Feed</button>
                    </SignedIn>
                </div>
            </nav>
            ...
            <main className="pt-8 lg:pt-24 pb-20 px-8 lg:px-20 overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    <div className="w-full lg:w-3/5 space-y-4 relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-2 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                            <button 
                                onClick={() => navigate("/browse")} 
                                className="group relative bg-black text-white px-10 py-4 rounded-xl text-md font-black uppercase tracking-[0.2em] hover:bg-gray-900 transition-all shadow-2xl shadow-black/20 overflow-hidden"
                            >
                            ...
                            <button 
                                ...
                                className="border-2 border-gray-200 px-10 py-4 rounded-xl text-md font-black uppercase tracking-[0.2em] hover:bg-gray-50 hover:border-gray-300 transition-all"
                            >
                                Get Started
                            </button>
                        </div>
